from backend.baseService import BaseService
from backend.repository import customerRepository, supplierRepository, productRepository, shoppingCartRepository, transcriptRepository, shipmentRepository, inventoryRepository, TokenRepository
import uuid
